...
public class SysYLexerParser extends Parser {
	...
	public final ProgContext prog() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << CONST) | (1L << INT) | (1L << VOID) | (1L << IF) | (1L << ELSE) | (1L << WHILE) | (1L << BREAK) | (1L << CONTINUE) | (1L << RETURN) | (1L << PLUS) | (1L << MINUS) | (1L << MUL) | (1L << DIV) | (1L << MOD) | (1L << ASSIGN) | (1L << EQ) | (1L << NEQ) | (1L << LT) | (1L << GT) | (1L << LE) | (1L << GE) | (1L << NOT) | (1L << AND) | (1L << OR) | (1L << L_PAREN) | (1L << R_PAREN) | (1L << L_BRACE) | (1L << R_BRACE) | (1L << L_BRACKT) | (1L << R_BRACKT) | (1L << COMMA) | (1L << SEMICOLON) | (1L << IDENT) | (1L << INTEGR_CONST) | (1L << WS) | (1L << LINE_COMMENT) | (1L << MULTILINE_COMMENT))) != 0)) {
				{
				{
				setState(2);
				matchWildcard();
	...
	public static final String _serializedATN =
		"\3\u608b\ua72a\u8133\ub9ed\u417c\u3be7\u7786\u5964\3\'\r\4\2\t\2\3\2\7"+
		"\2\6\n\2\f\2\16\2\t\13\2\3\2\3\2\3\2\2\2\3\2\2\2\2\f\2\7\3\2\2\2\4\6\13"+
